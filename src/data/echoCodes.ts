...
export const echoCategories: Record<string, EchoCode[]> = {
  'TTE': [
    ...
    { code: '93320', summary: 'Doppler echo, complete', description: 'Doppler echocardiography, pulsed wave and/or continuous wave with spectral display (List separately in addition to codes for echocardiographic imaging); complete', isAddOn: true, rvu: 0.38, colorTheme: 'sky' },
    { code: '93321', summary: 'Doppler echo, limited', description: 'Doppler echocardiography, pulsed wave and/or continuous wave with spectral display (List separately in addition to codes for echocardiographic imaging); follow-up or limited study (List separately in addition to codes for echocardiographic imaging)', isAddOn: true, rvu: 0.21, colorTheme: 'sky' },
    { code: '93325', summary: 'Color flow Doppler (add-on)', description: 'Doppler echocardiography color flow velocity mapping (List separately in addition to codes for echocardiography)', isAddOn: true, rvu: 0.17, colorTheme: 'sky' },
    { code: '93303', summary: 'TTE congenital, complete', description: 'Transthoracic echocardiography for congenital cardiac anomalies; complete', rvu: 1.75, colorTheme: 'sky' },
    { code: '93304', summary: 'TTE congenital, limited', description: 'Transthoracic echocardiography for congenital cardiac anomalies; follow-up or limited study', rvu: 0.85, colorTheme: 'sky' },
    { code: '93352', summary: 'Contrast agent for echo (add-on)', description: 'Use of echocardiographic contrast agent during stress echocardiography (List separately in addition to codes for primary procedure)', isAddOn: true, rvu: 0.15, colorTheme: 'sky' },
    { code: '93356', summary: 'Myocardial strain imaging (add-on)', description: 'Myocardial strain imaging using speckle tracking-derived assessment of myocardial mechanics (List separately in addition to codes for echocardiography imaging)', isAddOn: true, rvu: 0.25, colorTheme: 'sky' },
    { code: '93355', summary: '3D TEE for structural intervention', description: 'Echocardiography, transesophageal (TEE) for guidance of a transcatheter intracardiac or great vessel(s) structural intervention(s) (eg, TAVR, transcatheter pulmonary valve replacement, mitral valve repair, paravalvular regurgitation repair, left atrial appendage occlusion/closure, ventricular septal defect closure) (peri- and intra-procedural), real-time image acquisition and documentation, guidance with quantitative measurements, probe manipulation, interpretation, and report, including diagnostic transesophageal echocardiography and target ablation of ventricular tachycardia', rvu: 4.50, colorTheme: 'sky' },
    { code: '76376', summary: '3D rendering, concurrent', description: '3D rendering with interpretation and reporting of computed tomography, magnetic resonance imaging, ultrasound, or other tomographic modality with image postprocessing under concurrent supervision; not requiring image postprocessing on an independent workstation', rvu: 0.20, colorTheme: 'sky' },
    { code: '76377', summary: '3D rendering, workstation', description: '3D rendering with interpretation and reporting of computed tomography, magnetic resonance imaging, ultrasound, or other tomographic modality with image postprocessing under concurrent supervision; requiring image postprocessing on an independent workstation', rvu: 0.50, colorTheme: 'sky' }
  ],
...
export const echoCategoryColors: Record<string, { dot: string; bg: string; text: string; border: string }> = {
  'TTE': { dot: 'bg-sky-500', bg: 'bg-sky-50', text: 'text-sky-700', border: 'border-sky-200' },
  ...
  'Cardioversion': { dot: 'bg-pink-500', bg: 'bg-pink-50', text: 'text-pink-700', border: 'border-pink-200' }
};
